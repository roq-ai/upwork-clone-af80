...
-- AddForeignKey
ALTER TABLE "contract" ADD CONSTRAINT "contract_job_id_fkey" FOREIGN KEY ("job_id") REFERENCES "job"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
