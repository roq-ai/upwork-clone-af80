...
export default function AppLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <Box minH="100vh" bg={useColorModeValue('gray.100', 'gray.900')} zIndex={90000001}>
      <HelpBox />
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['job-poster', 'client'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    { name: 'Manage Team', icon: FiActivity, path: '/invites', entity: RoqResourceEnum.INVITE },
