...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  async function createApplication() {
    ...
    const body = { ...req.body };
    // console.log("new applicaiton api",{body, user, roqUserId})
    ...
    // await hire({ jobTitle: job.title, userId:job.company.tenant_id, applicantId: user.tenantId });
