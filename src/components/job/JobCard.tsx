...
import { Text, Button, Link, Icon, Divider, ButtonGroup, Stack } from '@chakra-ui/react';
            ...
            <CardFooter>
                <ButtonGroup spacing="2" justifyContent="space-between" display="flex" width="100%">
                    <Stack direction="row">
                        ...
                        {hasAccess('job', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && currentRole === 'job-applicant' && (
